          ...
          >
            ...
            <div className="bg-[#f0f0f0] p-4 flex justify-between items-center border-b border-gray-200">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-800 font-semibold">Secure Payment via Xsolla</span>
              </div>
              <button onClick={() => setSelectedProduct(null)} className="text-gray-500 hover:text-gray-800 font-bold">✕</button>
            </div>
            ...
            <div className="p-6">
              <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
                ...
                <div>
                  <h3 className="text-gray-800 font-bold text-lg">{selectedProduct.name}</h3>
                  <p className="text-gray-500 text-sm">{selectedProduct.type}</p>
                </div>
              ...
              <div className="text-center">
                <p className="text-xs text-gray-400">By continuing, you agree to the Terms of Service.</p>
              </div>
            </div>
          </motion.div>
        </div>
